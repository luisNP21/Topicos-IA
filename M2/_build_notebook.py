"""Genera el notebook 04_llm_judge.ipynb para la tarea de Agustín (M2)."""
import json
from pathlib import Path

OUT = Path(__file__).parent / "04_llm_judge.ipynb"
...
# ── SEC 0 ─────────────────────────────────────────────────────────────────────
cells.append(md("sec0", ["## 0. Setup e imports"]))

cells.append(code("drive", [
    "try:\n",
...
cells.append(md("sec1-2", ["### 1.2 Cargar el eval set (split test)\n"]))

cells.append(code("load_eval", [
...
cells.append(md("sec1-4", ["### 1.4 Cargar modelo fine-tuneado y definir inferencia\n"]))

cells.append(code("load_model", [
...
cells.append(code("rich_examples", [
...
cells.append(code("position_bias", [
...
cells.append(code("position_analysis", [
...
cells.append(code("length_pairs", [
    "LENGTH_BIAS_PAIRS = [\n",
...
cells.append(code("length_analysis", [
...
cells.append(code("interpretation", [
